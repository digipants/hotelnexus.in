...
jQuery('body').on('click', '.mtAlertBannerCloseTippy', function() {
    jQuery('body #mtAlertBanner').hide();
});
jQuery(document).ready(function() {
    var newURL = 'https://hotelnexus.in/banquet-hall/';
    jQuery('#post-1772 a, #post-1798 a, #post-1808 a').attr('href', newURL);

    //jQuery('.th-gmap-wrap').attr('id', 'map');
    var mapHTML = '<div class="elementor-element elementor-element-f6b81a4 elementor-widget elementor-widget-menu-anchor" data-id="f6b81a4" data-element_type="widget" data-widget_type="menu-anchor.default"><div class="elementor-widget-container"><div id="map" class="elementor-menu-anchor"></div></div></div>'
    jQuery('.elementor-widget-themo-google-maps').before(mapHTML);
});