...
function(t) {
    ...
    e.DEFAULTS = {
        ...
        return this.$element.trigger(h), h.isDefaultPrevented() ? void 0 : (this.sliding = !0, s && this.pause(), this.$indicators.length && (this.$indicators.find(".active").removeClass("active"), this.$element.one("slid.bs.carousel", function() {
            ...
            e && e.addClass("active")
        })), t.support.transition && this.$element.hasClass("slide") ? (n.addClass(e), n[0].offsetWidth, o.addClass(r), n.addClass(r), o.one(t.support.transition.end, function() {
    ...
    t.fn.carousel = function(i) {
        ...
        r && (s.interval = !1), n.carousel(s), (r = o.attr("data-slide-to")) && n.data("bs.carousel").to(r), e.preventDefault()
...
function(t) {
    ...
    t.fn.collapse = function(i) {
        ...
        var i, o = t(this),
            ...
            h = l && t(l);
        r && r.transitioning || (h && h.find('[data-toggle=collapse][data-parent="' + l + '"]').not(o).addClass("collapsed"), o[s.hasClass("in") ? "addClass" : "removeClass"]("collapsed")), s.collapse(a)
    })
}(jQuery),
function(t) {
    "use strict";
    ...
    s.prototype.toggle = function(o) {
        ...
        if (/(38|40|27)/.test(e.keyCode)) {
            ...
            if (e.preventDefault(), e.stopPropagation(), !o.is(".disabled, :disabled")) {
                var s = i(o),
                    r = s.hasClass("open");
                if (!r || r && 27 == e.keyCode) return 27 == e.which && s.find(n).focus(), o.click();
    ...
    e.DEFAULTS = {
        ...
        if (this.hasContent() && this.enabled) {
            ...
            if (r) {
                ...
                n = "bottom" == n && a.top + a.height + h - u > f ? "top" : "top" == n && a.top - u - h < 0 ? "bottom" : "right" == n && a.right + l > p ? "left" : "left" == n && a.left - l < m ? "right" : n, o.removeClass(c).addClass(n)
            }
        ...
        isNaN(a) && (a = 0), isNaN(l) && (l = 0), e.top = e.top + a, e.left = e.left + l, t.offset.setOffset(n[0], t.extend({
            using: function(t) {
                n.css({
        ...
        var h = n[0].offsetWidth,
            d = n[0].offsetHeight;
        if ("top" == i && d != r && (o = !0, e.top = e.top + r - d), /bottom|top/.test(i)) {
            var c = 0;
            e.left < 0 && (c = -2 * e.left, e.left = 0, n.offset(e), h = n[0].offsetWidth, d = n[0].offsetHeight), this.replaceArrow(c - s + h, h, "left")
...
function(t) {
    ...
    e.prototype.show = function() {
        ...
        r ? s.one(t.support.transition.end, n).emulateTransitionEnd(150) : n(), s.removeClass("in")
    };
    var i = t.fn.tab;
    t.fn.tab = function(i) {
        return this.each(function() {
    ...
    e.RESET = "affix affix-top affix-bottom", e.DEFAULTS = {
        ...
        if (this.$element.is(":visible")) {
            var i = t(document).height(),
                ...
                r = s.top,
                a = s.bottom;
            "top" == this.affixed && (n.top += o), "object" != typeof s && (a = r = s), "function" == typeof r && (r = s.top(this.$element)), "function" == typeof a && (a = s.bottom(this.$element));
            ...
            if (this.affixed !== l) {
                ...
                this.$element.trigger(d), d.isDefaultPrevented() || (this.affixed = l, this.unpin = "bottom" == l ? this.getPinnedOffset() : null, this.$element.removeClass(e.RESET).addClass(h).trigger(t.Event(h.replace("affix", "affixed"))), "bottom" == l && this.$element.offset({
...
function() {
    ...
    t = jQuery, (e = function(e, i) {
        ...
        navigateTo: function(e) {
            var i, o;
            return 0 > e || e > this.gallery_items.length - 1 ? this : (this.showLoading(), this.gallery_index = e, this.$element = t(this.gallery_items.get(this.gallery_index)), this.updateTitleAndFooter(), o = this.$element.attr("data-remote") || this.$element.attr("href"), this.detectRemoteType(o, this.$element.attr("data-type") || !1), this.gallery_index + 1 < this.gallery_items.length && (o = (i = t(this.gallery_items.get(this.gallery_index + 1), !1)).attr("data-remote") || i.attr("href"), "image" === i.attr("data-type") || this.isImage(o)) ? this.preloadImage(o, !1) : void 0)
        },
        ...
        updateTitleAndFooter: function() {
            var t, e, i, o;
            return i = this.modal_content.find(".modal-header"), e = this.modal_content.find(".modal-footer"), o = this.$element.data("title") || "", t = this.$element.data("footer") || "", o || this.options.always_show_close ? i.css("display", "").find(".modal-title").html(o || "&nbsp;") : i.css("display", "none"), t ? e.css("display", "").html(t) : e.css("display", "none"), this
        },
        ...
        showYoutubeVideo: function(t) {
            var e, i, o;
            return i = null != this.$element.attr("data-norelated") || this.options.no_related ? "&rel=0" : "", e = (o = this.checkDimensions(this.$element.data("width") || 560)) / (560 / 315), this.showVideoIframe("//www.youtube.com/embed/" + t + "?badge=0&autoplay=1&html5=1" + i, o, e)
        },
        showVimeoVideo: function(t) {
            var e, i;
            return e = (i = this.checkDimensions(this.$element.data("width") || 560)) / (500 / 281), this.showVideoIframe(t + "?autoplay=1", i, e)
        },
        ...
        preloadImage: function(e, i) {
            var o;
            return o = new Image, (null == i || !0 === i) && (o.onload = function(e) {
                return function() {
                    var i;
                    return (i = t("<img />")).attr("src", o.src), i.addClass("img-responsive"), e.lightbox_body.html(i), e.modal_arrows && e.modal_arrows.css("display", "block"), i.load(function() {
        ...
        scaleHeight: function(e, i) {
            var o, n, s, r, a, l;
            return r = this.modal_header.outerHeight(!0) || 0, s = this.modal_footer.outerHeight(!0) || 0, this.modal_footer.is(":visible") || (s = 0), this.modal_header.is(":visible") || (r = 0), o = this.border.top + this.border.bottom + this.padding.top + this.padding.bottom, a = parseFloat(this.modal_dialog.css("margin-top")) + parseFloat(this.modal_dialog.css("margin-bottom")), l = t(window).height() - o - a - r - s, n = Math.min(l / e, 1), this.modal_dialog.css("height", "auto").css("max-height", l), this.resize(n * i)
        },
        resize: function(e) {
            var i;
        ...
        checkDimensions: function(t) {
            return t + this.border.left + this.padding.left + this.padding.right + this.border.right > document.body.clientWidth && (t = this.modal_body.width()), t
        },
        close: function() {
            ...
            t.data(e, "flexslider", o), m = {
                init: function() {
                    o.animating = !1, o.currentSlide = parseInt(o.vars.startAt ? o.vars.startAt : 0, 10), isNaN(o.currentSlide) && (o.currentSlide = 0), o.animatingTo = o.currentSlide, o.atEnd = 0 === o.currentSlide || o.currentSlide === o.last, o.containerSelector = o.vars.selector.substr(0, o.vars.selector.search(" ")), o.slides = t(o.vars.selector, o), o.container = t(o.containerSelector, o), o.count = o.slides.length, o.syncExists = t(o.vars.sync).length > 0, "slide" === o.vars.animation && (o.vars.animation = "swing"), o.prop = d ? "top" : "marginLeft", o.args = {}, o.manualPause = !1, o.stopped = !1, o.started = !1, o.startTimeout = null, o.transitions = !o.vars.video && !p && o.vars.useCSS && function() {
                        ...
                        return !1
                    }(), o.ensureAnimationEnd = "", "" !== o.vars.controlsContainer && (o.controlsContainer = t(o.vars.controlsContainer).length > 0 && t(o.vars.controlsContainer)), "" !== o.vars.manualControls && (o.manualControls = t(o.vars.manualControls).length > 0 && t(o.vars.manualControls)), o.vars.randomize && (o.slides.sort(function() {
                    ...
                    }), o.vars.pauseInvisible && m.pauseInvisible.isHidden() || (o.vars.initDelay > 0 ? o.startTimeout = setTimeout(o.play, o.vars.initDelay) : o.play())), f && m.asNav.setup(), a && o.vars.touch && m.touch(), (!p || p && o.vars.smoothHeight) && t(window).bind("resize orientationchange focus", m.resize), o.find("img").attr("draggable", "false"), setTimeout(function() {
                        o.vars.start(o)
                    }, 200)
                },
                asNav: {
                        ...
                        if (o.controlNavScaffold = t('<ol class="' + s + "control-nav " + s + n + '"></ol>'), o.pagingCount > 1)
                            for (var a = 0; a < o.pagingCount; a++) {
                                if (i = o.slides.eq(a), e = "thumbnails" === o.vars.controlNav ? '<img src="' + i.attr("data-thumb") + '"/>' : "<a>" + r + "</a>", "thumbnails" === o.vars.controlNav && !0 === o.vars.thumbCaptions) {
                                    ...
                                    "" != d && null != d && (e += '<span class="' + s + 'caption">' + d + "</span>")
                                }
                ...
                directionNav: {
                    setup: function() {
                        ...
                        o.controlsContainer ? (t(o.controlsContainer).append(e), o.directionNav = t("." + s + "direction-nav li a", o.controlsContainer)) : (o.append(e), o.directionNav = t("." + s + "direction-nav li a", o)), m.directionNav.update(), o.directionNav.bind(l, function(e) {
                            var i;
                            e.preventDefault(), ("" === h || h === e.type) && (i = o.getTarget(t(this).hasClass(s + "next") ? "next" : "prev"), o.flexAnimate(i, o.vars.pauseOnAction)), "" === h && (h = e.type), m.setToClearWatchedEvent()
                        })
                    },
                    update: function() {
                        var t = s + "disabled";
                ...
                pausePlay: {
                    setup: function() {
                        ...
                        o.controlsContainer ? (o.controlsContainer.append(e), o.pausePlay = t("." + s + "pauseplay a", o.controlsContainer)) : (o.append(e), o.pausePlay = t("." + s + "pauseplay a", o)), m.pausePlay.update(o.vars.slideshow ? s + "pause" : s + "play"), o.pausePlay.bind(l, function(e) {
                            e.preventDefault(), ("" === h || h === e.type) && (t(this).hasClass(s + "pause") ? (o.manualPause = !0, o.manualPlay = !1, o.pause()) : (o.manualPause = !1, o.manualPlay = !0, o.play())), "" === h && (h = e.type), m.setToClearWatchedEvent()
                        })
                    },
                    update: function(t) {
                ...
                touch: function() {
                    function t(t) {
                        g = t.touches[0].pageX, v = t.touches[0].pageY, h = d ? n - v : n - g;
                        (!(m = d ? Math.abs(h) < Math.abs(g - s) : Math.abs(h) < Math.abs(v - s)) || Number(new Date) - f > 500) && (t.preventDefault(), !p && o.transitions && (o.vars.animationLoop || (h /= 0 === o.currentSlide && 0 > h || o.currentSlide === o.last && h > 0 ? Math.abs(h) / l + 2 : 1), o.setProps(a + h, "setTouch")))
                    }

                    function i(r) {
                        if (e.removeEventListener("touchmove", t, !1), o.animatingTo === o.currentSlide && !m && null !== h) {
                            var d = c ? -h : h,
                                u = o.getTarget(d > 0 ? "next" : "prev");
                            o.canAdvance(u) && (Number(new Date) - f < 550 && Math.abs(d) > 50 || Math.abs(d) > l / 2) ? o.flexAnimate(u, o.vars.pauseOnAction) : p || o.flexAnimate(o.currentSlide, o.vars.pauseOnAction, !0)
                        }
                        e.removeEventListener("touchend", i, !1), n = null, s = null, h = null, a = null
                    }
                    var n, s, a, l, h, f, m = !1,
                        g = 0,
                        v = 0,
                    ...
                    r ? (e.style.msTouchAction = "none", e._gesture = new MSGesture, e._gesture.target = e, e.addEventListener("MSPointerDown", function(t) {
                        t.stopPropagation(), o.animating ? t.preventDefault() : (o.pause(), e._gesture.addPointer(t.pointerId), y = 0, l = d ? o.h : o.w, f = Number(new Date), a = u && c && o.animatingTo === o.last ? 0 : u && c ? o.limit - (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo : u && o.currentSlide === o.last ? o.limit : u ? (o.itemW + o.vars.itemMargin) * o.move * o.currentSlide : c ? (o.last - o.currentSlide + o.cloneOffset) * l : (o.currentSlide + o.cloneOffset) * l)
                    }, !1), e._slider = o, e.addEventListener("MSGestureChange", function(t) {
                        t.stopPropagation();
                        var i = t.target._slider;
                        if (i) {
                            var o = -t.translationX,
                                n = -t.translationY;
                            return h = y += d ? n : o, m = d ? Math.abs(y) < Math.abs(-o) : Math.abs(y) < Math.abs(-n), t.detail === t.MSGESTURE_FLAG_INERTIA ? void setImmediate(function() {
                                e._gesture.stop()
                            }) : void((!m || Number(new Date) - f > 500) && (t.preventDefault(), !p && i.transitions && (i.vars.animationLoop || (h = y / (0 === i.currentSlide && 0 > y || i.currentSlide === i.last && y > 0 ? Math.abs(y) / l + 2 : 1)), i.setProps(a + h, "setTouch"))))
                        }
                    }, !1), e.addEventListener("MSGestureEnd", function(t) {
                        t.stopPropagation();
                        var e = t.target._slider;
                        if (e) {
                            if (e.animatingTo === e.currentSlide && !m && null !== h) {
                                var i = c ? -h : h,
                                    o = e.getTarget(i > 0 ? "next" : "prev");
                                e.canAdvance(o) && (Number(new Date) - f < 550 && Math.abs(i) > 50 || Math.abs(i) > l / 2) ? e.flexAnimate(o, e.vars.pauseOnAction) : p || e.flexAnimate(e.currentSlide, e.vars.pauseOnAction, !0)
                            }
                            n = null, s = null, h = null, a = null, y = 0
                        }
                    }, !1)) : e.addEventListener("touchstart", function(r) {
                        o.animating ? r.preventDefault() : (window.navigator.msPointerEnabled || 1 === r.touches.length) && (o.pause(), l = d ? o.h : o.w, f = Number(new Date), g = r.touches[0].pageX, v = r.touches[0].pageY, a = u && c && o.animatingTo === o.last ? 0 : u && c ? o.limit - (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo : u && o.currentSlide === o.last ? o.limit : u ? (o.itemW + o.vars.itemMargin) * o.move * o.currentSlide : c ? (o.last - o.currentSlide + o.cloneOffset) * l : (o.currentSlide + o.cloneOffset) * l, n = d ? v : g, s = d ? g : v, e.addEventListener("touchmove", t, !1), e.addEventListener("touchend", i, !1))
                    }, !1)
                },
                resize: function() {
                    !o.animating && o.is(":visible") && (u || o.doMath(), p ? m.smoothHeight() : u ? (o.slides.width(o.computedW), o.update(o.pagingCount), o.setProps()) : d ? (o.viewport.height(o.h), o.setProps(o.h, "setTotal")) : (o.vars.smoothHeight && m.smoothHeight(), o.newSlides.width(o.computedW), o.setProps(o.computedW, "setTotal")))
                },
                ...
                if (o.vars.animationLoop || e === o.currentSlide || (o.direction = e > o.currentSlide ? "next" : "prev"), f && 1 === o.pagingCount && (o.direction = o.currentItem < e ? "next" : "prev"), !o.animating && (o.canAdvance(e, l) || n) && o.is(":visible")) {
                    if (f && r) {
                        ...
                        if (o.atEnd = 0 === e || e === o.count - 1, h.flexAnimate(e, !0, !1, !0, l), o.direction = o.currentItem < e ? "next" : "prev", h.direction = o.direction, Math.ceil((e + 1) / o.visible) - 1 === o.currentSlide || 0 === e) return o.currentItem = e, o.slides.removeClass(s + "active-slide").eq(e).addClass(s + "active-slide"), !1;
                        o.currentItem = e, o.slides.removeClass(s + "active-slide").eq(e).addClass(s + "active-slide"), e = Math.floor(e / o.visible)
                    }
                    if (o.animating = !0, o.animatingTo = e, i && o.pause(), o.vars.before(o), o.syncExists && !l && m.sync("animate"), o.vars.controlNav && m.controlNav.active(), u || o.slides.removeClass(s + "active-slide").eq(e).addClass(s + "active-slide"), o.atEnd = 0 === e || e === o.last, o.vars.directionNav && m.directionNav.update(), e === o.last && (o.vars.end(o), o.vars.animationLoop || o.pause()), p) a ? (o.slides.eq(o.currentSlide).css({
                        opacity: 0,
                        zIndex: 1
                    }), o.slides.eq(e).css({
                        opacity: 1,
                ...
                p || u || (0 === o.currentSlide && o.animatingTo === o.last && o.vars.animationLoop ? o.setProps(t, "jumpEnd") : o.currentSlide === o.last && 0 === o.animatingTo && o.vars.animationLoop && o.setProps(t, "jumpStart")), o.animating = !1, o.currentSlide = o.animatingTo, o.vars.after(o)
                ...
                var n = function() {
                    ...
                    return -1 * function() {
                        if (u) return "setTouch" === e ? t : c && o.animatingTo === o.last ? 0 : c ? o.limit - (o.itemW + o.vars.itemMargin) * o.move * o.animatingTo : o.animatingTo === o.last ? o.limit : i;
                        switch (e) {
                            case "setTotal":
                                return c ? (o.count - 1 - o.currentSlide + o.cloneOffset) * t : (o.currentSlide + o.cloneOffset) * t;
                            case "setTouch":
                                return t;
                            case "jumpEnd":
                ...
                var n = t(e);
                o.count += 1, o.last = o.count - 1, d && c ? void 0 !== i ? o.slides.eq(o.count - i).after(n) : o.container.prepend(n) : void 0 !== i ? o.slides.eq(i).before(n) : o.container.append(n), o.update(i, "add"), o.slides = t(o.vars.selector + ":not(.clone)", o), o.setup(), o.vars.added(o)
            }, o.removeSlide = function(e) {
                var i = isNaN(e) ? o.slides.index(t(e)) : e;
                o.count -= 1, o.last = o.count - 1, isNaN(e) ? t(e, o.slides).remove() : d && c ? o.slides.eq(o.last).remove() : o.slides.eq(e).remove(), o.doMath(), o.update(i, "remove"), o.slides = t(o.vars.selector + ":not(.clone)", o), o.setup(), o.vars.removed(o)
            }, m.init()
    ...
    function(t, e, i) {
        ...
        t.fn.scrollUp = function(e) {
            ...
            var n, s, r, a, l, h, d = t.fn.scrollUp.settings = t.extend({}, t.fn.scrollUp.defaults, o),
                c = !1;
            ...
            a = "top" === d.scrollFrom ? d.scrollDistance : t(i).height() - t(e).height() - d.scrollDistance, t(e).scroll(function() {
                t(e).scrollTop() > a ? c || (h[n](r), c = !0) : c && (h[s](r), c = !1)
            }), d.scrollTarget ? "number" == typeof d.scrollTarget ? l = d.scrollTarget : "string" == typeof d.scrollTarget && (l = Math.floor(t(d.scrollTarget).offset().top)) : l = 0, h.click(function(e) {
    ...
    function(t, e) {
        ...
        function o(o) {
            if (i(), "string" == typeof o && (o = document.querySelector(o)), o && "object" == typeof o && o.nodeType) {
                ...
                for (var h = l.isBorderBox = "border-box" == s.boxSizing, d = 0; d < a; d++) {
                    var c = r[d],
                        u = s[c],
                        p = parseFloat(u);
                    l[c] = isNaN(p) ? 0 : p
                ...
                var _ = t(s.height);
                return !1 !== _ && (l.height = _ + (x ? 0 : m + b)), l.innerWidth = l.width - (f + y), l.innerHeight = l.height - (m + b), l.outerWidth = l.width + g, l.outerHeight = l.height + v, l
            }
        }
    ...
    function(t, e) {
        ...
        return o._resetLayout = function() {
            ...
            for (var l = (this._getOption("originTop") ? o.top : o.bottom) + i.outerHeight, h = r; h <= a; h++) this.colYs[h] = Math.max(l, this.colYs[h])
    ...
    function(t, e, i) {
        ...
        var c = e.documentElement,
            ...
            p = h._config.usePrefixes ? " -webkit- -moz- -o- -ms- ".split(" ") : ["", ""];
        h._prefixes = p, d.addTest("csspointerevents", function() {
            var t = n("a").style;
        ...
        h.mq = m, d.addTest("mediaqueries", m("only all")),
            function() {
                var t, e, i, n, s, r;
                for (var h in l)
                    if (l.hasOwnProperty(h)) {
                        if (t = [], (e = l[h]).name && (t.push(e.name.toLowerCase()), e.options && e.options.aliases && e.options.aliases.length))
                            for (i = 0; i < e.options.aliases.length; i++) t.push(e.options.aliases[i].toLowerCase());
                        for (n = o(e.fn, "function") ? e.fn() : e.fn, s = 0; s < t.length; s++) 1 === (r = t[s].split(".")).length ? d[r[0]] = n : (!d[r[0]] || d[r[0]] instanceof Boolean || (d[r[0]] = new Boolean(d[r[0]])), d[r[0]][r[1]] = n), a.push((n ? "" : "no-") + r.join("-"))
                    }
            }(),
            function(t) {
                var e = c.className,
                ...
                d._config.enableClasses && (e += " " + i + t.join(" " + i), u ? c.className.baseVal = e : c.className = e)
            }(a), delete h.addTest, delete h.addAsyncTest;
    ...
    function(t, e) {
        ...
        "use strict";
        var t = function(e, i) {
                for (var o in i) i.hasOwnProperty(o) && (e[o] = "object" == typeof i[o] ? t(e[o], i[o]) : i[o]);
                return e
            },
            e = function(t, e) {
                var i, o, n, s = Date.now || function() {
                ...
                return function() {
                    var h = s(),
                        d = e - (h - a);
                    return i = this, o = arguments, 0 >= d ? (clearTimeout(r), r = null, a = h, n = t.apply(i, o), i = o = null) : r || (r = setTimeout(l, d)), n
                }
            },
            i = function(e, i) {
        ...
        return i.prototype = {
            ...
            _setScrollOffset: function() {
                "string" == typeof this.options.offset && (this.scrollOffset = function(t, e) {
                    for (var i = 0, o = t.offsetHeight; t;) i += t.offsetTop, t = t.offsetParent;
    ...
    function(t, e) {
        ...
        function i(t, e) {
            ...
            }), o.setAttribute("src", e), t.setAttribute(c, !0)
        }
        ...
        function s(t) {
            (function(t) {
                return t ? "function" == typeof t.forEach ? t : e(t) : "undefined" != typeof document ? e(document.querySelectorAll(d)) : []
            })(t).forEach(function(t) {
                if (!t.getAttribute(c)) {
    ...
    function(t, e, i, o) {
        function n(e, i) {
            ...
            if (r.length < 1 && r.push("center"), 1 == r.length && r.push(r[0]), "top" != r[0] && "bottom" != r[0] && "left" != r[1] && "right" != r[1] || (r = [r[1], r[0]]), this.positionX !== o && (r[0] = this.positionX.toLowerCase()), this.positionY !== o && (r[1] = this.positionY.toLowerCase()), s.positionX = r[0], s.positionY = r[1], "left" != this.positionX && "right" != this.positionX && (isNaN(parseInt(this.positionX)) ? this.positionX = "center" : this.positionX = parseInt(this.positionX)), "top" != this.positionY && "bottom" != this.positionY && (isNaN(parseInt(this.positionY)) ? this.positionY = "center" : this.positionY = parseInt(this.positionY)), this.position = this.positionX + (isNaN(this.positionX) ? "" : "px") + " " + this.positionY + (isNaN(this.positionY) ? "" : "px"), navigator.userAgent.match(/(iPod|iPhone|iPad)/)) return this.imageSrc && this.iosFix && !this.$element.is("img") && this.$element.css({
            ...
            render: function() {
                var t = n.scrollTop,
                    ...
                    o = t + n.winHeight;
                this.boxOffsetBottom > t && this.boxOffsetTop <= o ? (this.visibility = "visible", this.mirrorTop = this.boxOffsetTop - t, this.mirrorLeft = this.boxOffsetLeft - e, this.offsetTop = this.offsetBaseTop - this.mirrorTop * (1 - this.speed)) : this.visibility = "hidden", this.$mirror.css({
            ...
            setup: function() {
                if (!this.isReady) {
                    var o = this,
                        ...
                        r = t(e),
                        a = function() {
                            n.winHeight = r.height(), n.winWidth = r.width(), n.docHeight = s.height(), n.docWidth = s.width()
                        },
                        l = function() {
                            var t = r.scrollTop(),
            ...
            destroy: function(i) {
                var o, s = t(i).data("px.parallax");
                for (s.$mirror.remove(), o = 0; o < this.sliders.length; o += 1) this.sliders[o] == s && this.sliders.splice(o, 1);
